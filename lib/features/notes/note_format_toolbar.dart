      ...
      child: Row(
        children: [
          ...
          for (final (action, icon, label) in const [
            ...
            (NoteFormatAction.bold, Icons.format_bold_rounded, 'Bold · Ctrl+B'),
            (
            ...
            (NoteFormatAction.checklist, Icons.checklist_rounded, 'Checklist'),
            (NoteFormatAction.quote, Icons.format_quote_rounded, 'Quote'),
            (NoteFormatAction.inlineCode, Icons.code_rounded, 'Inline code'),
            (
